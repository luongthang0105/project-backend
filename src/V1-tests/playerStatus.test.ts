...
describe('playerJoinSession', () => {
  ...
  test('(NOT YET TO BE TESTED) Success: At question 1', () => {
    const player1 = playerJoinSession(session1, "Thomas");
    expect(player1).toStrictEqual({
      content: {
        playerId: expect.any(Number)
  ...
  test('(NOT YET TO BE TESTED) Success: At END state', () => {
    const player1 = playerJoinSession(session1, "Thomas");
    expect(player1).toStrictEqual({
      content: {
        playerId: expect.any(Number)
  ...
  test('(NOT YET TO BE TESTED) Success: At FINAL_RESULTS state', () => {
    const player1 = playerJoinSession(session1, "Thomas");
    expect(player1).toStrictEqual({
      content: {
        playerId: expect.any(Number)
  ...
  test('(NOT YET TO BE TESTED) Success: At question 2', () => {
    const player1 = playerJoinSession(session1, "Thomas");
    expect(player1).toStrictEqual({
      content: {
        playerId: expect.any(Number)
