...
describe("adminQuizCreate", () => {
    ...
    test('AuthUserId is not a valid user: dataStore has 1 user', () => {
        ...
        expect(adminQuizCreate(user.authUserId + 1, 'Hayden', 'This is my quiz')).toStrictEqual({
            error: "AuthUserId is not a valid user",
        })
    })
    ...
    test('AuthUserId is not a valid user: dataStore has 2 users', () => {
        ...
        expect(adminQuizCreate(user02.authUserId + 1, 'Hayden', 'This is my quiz')).toStrictEqual({
            error: "AuthUserId is not a valid user",
        })
    })
    ...
    test('Name contains invalid characters: mixed with letters and special character', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, 'Han Hanh!', 'This is my quiz')).toStrictEqual({
    ...
    test('Name contains invalid characters: only special characters', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, '----', 'This is my quiz')).toStrictEqual({
            error: "Name contains invalid characters"
        })
    })
    ...
    test('Name contains invalid characters: mixed with numbers and special characters', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, '1234+', 'This is my quiz')).toStrictEqual({
            error: "Name contains invalid characters"
        })
    })
    ...
    test('Name is less than 3 characters long: with only letters', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, 'Hi', 'This is my quiz')).toStrictEqual({
    ...
    test('Name is less than 3 characters long: with only number', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, '1', 'This is my quiz')).toStrictEqual({
            error: "Name is less than 3 characters long"
        })
    })
    ...
    test('Name is less than 3 characters long: mixed with number and letter', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, '1H', 'This is my quiz')).toStrictEqual({
            error: "Name is less than 3 characters long"
        })
    })
    ...
    test('Name is more than 30 characters long', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, 'okiokiokiokiokiokiokiokiokiokioki', 'This is my quiz')).toStrictEqual({
    ...
    test('Name is already used by the current logged in user for another quiz', () => {
        ...
        expect(adminQuizCreate(user.authUserId, 'quiz', 'This is my quiz')).toStrictEqual({
    ...
    test('Description is more than 100 characters in length', () => {
        const user = adminAuthRegister('han@gmai.com', '2705uwuwuwuwuwuw', 'Han', 'Hanh')
        expect(adminQuizCreate(user.authUserId, 'Han', 'Llllorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec qu')).toStrictEqual({
