...
describe ('adminAuthLogin', () => {
  ...
  test('ERROR: Password is not correct for the given email', () => {
    ...
    expect(error).toEqual({error: 'Password is not correct for the given email'})
  })
  ...
  test('Success: 1 person registered', () => {
    const userId1 = adminAuthRegister('javascript@gmail.com', 'aikfnrg7', 'Java', 'Script')
  ...
  test('Success: More than 1 person registered', () => {
    adminAuthRegister('javascript@gmail.com', 'aikfnrg7', 'Java', 'Script')
    const userId2 = adminAuthRegister('java@gmail.com', 'gdnkgeg4', 'Hello', 'World')
