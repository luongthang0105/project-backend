...
describe('adminQuizList', () => {
  test('ERROR: AuthUserId is not a valid user', () => {
    const user1  = adminAuthRegister('sasaki@gmail.com', 'hdngied3,', 'Mutsuki', 'Sasaki').authUserId
  ...
  test('SUCCESS: 2 quizzes for user1 and 1 quiz for user2 ', () => {
    const user1 = adminAuthRegister('sasaki@gmail.com', 'hdngied3,', 'Mutsuki', 'Sasaki').authUserId
    const user2 = adminAuthRegister('mutsuki@gmail.com', 'adfweweee7', 'Java', 'Script').authUserId
    const quiz1 = adminQuizCreate(user1,'Quiz1', 'good quiz').quizId
